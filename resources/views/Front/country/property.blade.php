			...
			<div class="row">
				<div class="col-lg-6 offset-lg-3">
					<div class="main-title text-center mb40">
						...
						<span class="text-primary">{{$coun_name['name']}}</span>
					</div>
				</div>
				<div class="col-lg-12">
							...
							<div class="feat_property">
								...
								<div class="details">
									<div class="tc_content">
										...
										<p><span class="flaticon-placeholder"></span><a href="{{route('countryProperty',$prop->country_id)}}"> {{$prop->country['name']}}</a>, {{$prop->address}}</p>
