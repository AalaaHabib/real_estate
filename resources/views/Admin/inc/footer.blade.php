...
<script type="text/javascript" src="{{asset('Front/js')}}/chart.min.js"></script>
<script type="text/javascript" src="{{asset('Front/js')}}/chart-custome.js"></script>
...
<script type="text/javascript" src="{{asset('Front/js')}}/wow.min.js"></script>
<script type="text/javascript" src="{{asset('Front/js')}}/dashboard-script.js"></script>
